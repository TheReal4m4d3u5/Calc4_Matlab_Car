...
% heading is the direction the car is currently facing
heading = 'E';
...
for moveNum = 1:numMoves
    ...
    % choose only among left / right / straight that stay in bounds
    ...
    % move one cell forward in the NEW heading
...
function y = headingToYaw(heading)
    % Keep your original car orientation convention
    switch heading
        case 'E'
            y = pi;
        case 'W'
